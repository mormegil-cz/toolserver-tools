...
$award_definitions[] = array('Veterán I. třídy', 40000, 4 * 365 + 183);
$award_definitions[] = array('Veterán II. třídy', 30000, 4 * 365);
$award_definitions[] = array('Veterán III. třídy', 20000, 3 * 365 + 183);
$award_definitions[] = array('Medaile profesionálního uživatele', 16000, 3 * 365);
$award_definitions[] = array('Wikipedista I. třídy', 12000, 2 * 365 + 183);
$award_definitions[] = array('Wikipedista II. třídy', 8000, 2 * 365);
$award_definitions[] = array('Wikipedista III. třídy', 6000, 1 * 365 + 183);
$award_definitions[] = array('Medaile zkušeného uživatele', 4000, 1 * 365);
$award_definitions[] = array('Student', 2000, 183);
$award_definitions[] = array('Učeň', 1000, 91);
$award_definitions[] = array('Nováček', 200, 30);
